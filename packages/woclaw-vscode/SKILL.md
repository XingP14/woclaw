...
woclaw-vscode 状态栏 sidebar tree 配合 CodexBar macOS 菜单栏 + addyosmani skill.yaml + dotnet/skills microsoft marketplace + awesome-claude-code 社区合集 4 层路由; woclaw-vscode 状态栏配合腾讯 CubeSandbox Rust Wasm 沙箱执行第三方 skill (2026-07 AI Agent 技能标准化 + 多智能体沙盒化 + 菜单栏生态 三主战场首日钣定) compatible