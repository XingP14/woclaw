...
codex-woclaw-example Python 钩子示例跨 addyosmani skill.yaml + dotnet/skills microsoft marketplace + awesome-claude-code 社区合集 3 层路由 (2026-07 AI Agent 技能标准化 + 多智能体沙盒化 + 菜单栏生态 三主战场首日钣定) compatible