...
opencode-woclaw-plugin 6 工具跨 addyosmani skill.yaml + dotnet/skills + awesome-claude-code 3 层路由; CodexBar 菜单栏 + 腾讯 CubeSandbox Rust 沙箱 配合 (2026-07 AI Agent 技能标准化 + 多智能体沙盒化 + 菜单栏生态 三主战场首日钣定) compatible