...
compatible_with: [256k-context-on-device, agensi, agensi-8-point-security-scan-80-20-payments, agent-browser-compat, agentskills-io-allowed-tools-field, agentskills-io-compatibility-field, agentskills-skills-ref-validated, alirezarezvani-claude-skills-1042-commits-2026-05, android-cli-1-0-compatible, anthropic-agent-sdk, anthropic-agent-skills, anthropic-fable-5-export-restriction-2026-06, anthropics-skills-claude-api-scheduled-deployments-2026-06, autonomous-research-agents, aws-platform, cc-switch-cross-platform-router, claude-agent-sdk, claude-code, claude-code-1m-context-compatible, claude-code-2-5, claude-code-deeper-sub-agent-nesting, claude-code-searchable-plugin-marketplace, claude-code-v2-1-157-auto-load, claude-code-v2-1-177-plugin-marketplace, claude-design-admin-role-2026-06, claude-design-brand-kit-2026-06, claude-design-code-bridge-2026-06, claude-design-enterprise-alliance-2026-06, claude-fable-5-compatible, claude-managed-agents, claude-project-purge-compatible, claude-skill-creator-v2, clawhub-52k-tools-2026-06, clawhub-cards-v3, clawhub-china-mirror-2026-06, clawhub-cn-official-skills-2026-06, clawhub-skill-install-cli, clawhub-skills, codex, cursor-spacex-60b-2026-06, dot-claude-skills-deployable, encoder-free-multimodal, expensify-mcp-4-client-shared-protocol-2026-06, fable-5-safe-fallback, gemini-antigravity-compatible, gemini-cli, gemma-4-12b-on-device, google-android-skills-compatible, lobehub-skills-marketplace, lvp-onprem-openclaw-enterprise-2026-06, mcp-tunnels, mythos-5-cybersecurity, npx-skills-add-cross-ecosystem, openai-codex-cli, openclaw-2026-6-7-skill-workflow-v2, openclaw-2026-6-8-beta-2-hotfix, openclaw-active-memory-plugin-2026-h1, openclaw-china-user-survey-2026-06, openclaw-copilot-oauth-image-defaults-2026-06, openclaw-lm-studio-binary-thinking-models-2026-06, openclaw-managed-secretref, openclaw-managed-secrets-2026-06, openclaw-os-level-sandbox-mxc-pin, openclaw-paradigm-aligned, openclaw-skill-monetization-freemium-api-backend-2026-06, openclaw-skills-entries-config, openclaw-v2026-6-1-recovery-from-interrupted-tool-calls, openclaw-v2026-6-2-operator-install-policy-2026-06, openclaw-v2026-6-8, openclaw-v2026-6-8-secretref-credential-durability, opencode, opencode-cli, opencode-plugin, phishing-resistant-2026-06, plugin-update-npm-sourced-fix, project-glasswing-2026-06, python-hooks, skill-auto-optimize-trigger, skill-creator-ab-compatible, skills-manager-centralized-hub, skills-sh, skills-sh-vercel-registry-compatible, skillsllm-1600-security-vetted-marketplace, skillvetbench-self-audit, tcs-anthropic-global-premier-partnership-2026-06, varonis-openclaw-pinchy, vercel-skills, vs-code-marketplace, vscode, x15-tools-softlink-sync, x402-agent-commerce-2026-06]
...
Fable 5 + Mythos 5 export restrictions (hooks 7 shell 钩子按国别 fallback Fable 5 → Opus 4.8) + Claude Design enterprise overhaul (hooks Claude Code /design 命令配合 woclaw-hub 双向桥接) + Expensify MCP 4 客户端共享协议 (hooks 7 shell 钩子配合 Expensify 4 端 (ChatGPT/Claude/Cursor/OpenClaw) 共享 MCP 协议) + SpaceX $60B Cursor 战略收购 (hooks 在 Cursor 客户端 enterprise 持续 support) 4 件套 compatible (2026-06-12 ~ 2026-06-17 国别 + 企业 + 协议 + 战略 4 转折首批锚定)
...
hooks 7 shell 钩子配合 OpenClaw v2026.6.1 runtime 韧性兼容 (interrupted tool calls 自动恢复 + stale session bindings 重建 + compaction handoffs 接续, PreCompact/SessionStart/SessionStop 事件不掉链) + hooks install 走 OpenClaw v2026.6.2-beta.1+ operator install policy 替代 dangerous-code scanner + hooks 国别路由元数据让中国 OpenClaw Team 部署走中国市场 ranking (C 端 5 分层 + 企业组织支持度) (2026-06-01 ~ 2026-06-19 runtime 韧性 + install 安全栈 + 中国市场真实使用验证 3 转折首批锚定) compatible
