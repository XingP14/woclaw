...
_Last updated: 2026-06-04 (v0.6+ 「RS-1 Repo 拆分」Step 1 方案设计完成; hub/v0.5.0 GitHub Release 已发布; site/quickstart.html Step 2 同步 /ready curl 例子 + 区分 liveness/readiness probe; 4 个 README npm 徽章与 npm registry 对齐)_
